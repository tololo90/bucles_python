...
def ej2():
    ...
    for color in colores:
        print(f"elemento de la lista {color}")
...
def ej3():
    ...
    for numero in numeros:
        suma += numero
        print(f"numero = {numero} total = {suma}")
...
def ej4():
    ...
    # una condición compuesta (utilice el operador "and" o "or"
    # según corresponda)
    ...
    # Realice el mismo bucle "while" pero en vez de estar
    # formado por una condición
    # compuesta, que el "while" siga iterando mientras
    # <x sea menos a 10>, y dentro del
    # "while" consultar si <x es igual a 6>, y en ese caso
    # realizar una interrupción del bucle
    # En cada iteracion del bucle debe incrementar el valor de "x" en "2"
    # e imprimir en pantalla el resultado de X (antes de incrementar) con print
    x_2 = 0
    while x_2 < 10:
...
def ej5():
    ...
    # Tener en cuenta que "range" no incluye el número
    # de "fin" en su secuencia,
    # sino que va hasta el anterior
    print("ingrese dos números que representen el principio "
          "y fin de una secuencia numérica")
    ...
    for numero in range(inicio, fin + 1):
        sumatoria += numero
        print(f"numero = {numero} total = {sumatoria}")
...
def ej6():
    ...
    # secuencia numérica.
    # Realizar un bucle "for" que recorra esa secuencia armada con "range"
    # y cuante cuantes números son negativos y cuantos
    # números son mayor o igual a cero
    # Tener en cuenta que "range" no incluye el número
    # de "fin" en su secuencia,
    # sino que va hasta el anterior
    print("ingrese dos números que representen el principio\n"
          "y fin de una secuencia numérica y que el primero "
          "sea negativo")
    inicio = int(input('Ingrese el primero número de la secuencia\n'))
    # fin....
    fin = int(input("ingrese el ultimo numero de la secuencia\n"))
